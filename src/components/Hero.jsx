            ...
            <div className='max-w-[800px]' >
                ...
                <h2 className='text-gray-300'></h2>
                  ...
                  <button   className='transform tramsition-transform hover:scale-105 hover:shadow-lg
                    ...
                    bg-gradient-to-r from-[#50a7c7] via-[#1f7cBf] to-[#3d6ca4] rounded-xl'><a className='block w-full h-full text-center' target='_blank' rel="noopener noreferrer"  href='/Portfolio/public/Lebenslauf_A.pdf'>Lebenslauf ansehen</a></button>
